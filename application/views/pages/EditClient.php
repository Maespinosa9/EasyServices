    ...
    <section class="well">
        ...
        <form class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control k-textbox" id="DOC_CLIENTE" name="DOC_CLIENTE" placeholder="Identificación" >
                </div>
                <div class="col-sm-2">
                    <label for="CIUDAD_ID" class="control-label">Ciudad</label>
                </div>
                <div class="col-sm-4">
                    <input type="text" class="form-control k-dropdown" id="CIUDAD_ID" name="CIUDAD_ID" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control k-textbox" id="BARRIO" name="BARRIO" placeholder="Barrio" >
                </div>
            </div>
